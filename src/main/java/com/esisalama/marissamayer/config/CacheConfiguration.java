...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.esisalama.marissamayer.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.esisalama.marissamayer.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.esisalama.marissamayer.domain.User.class.getName());
            createCache(cm, com.esisalama.marissamayer.domain.Authority.class.getName());
            createCache(cm, com.esisalama.marissamayer.domain.User.class.getName() + ".authorities");
            ...
            createCache(cm, com.esisalama.marissamayer.domain.Notification.class.getName());
            createCache(cm, com.esisalama.marissamayer.domain.Evaluation.class.getName());
            createCache(cm, com.esisalama.marissamayer.domain.Creneau.class.getName());
