...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UTILISATEUR_LIST actions', async () => {
    ...
    it('dispatches FETCH_UTILISATEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_UTILISATEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_UTILISATEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_UTILISATEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_UTILISATEUR actions', async () => {
      const expectedActions = [
        {
