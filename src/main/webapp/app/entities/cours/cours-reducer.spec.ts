...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './cours.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COURS_LIST actions', async () => {
    ...
    it('dispatches FETCH_COURS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COURS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COURS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COURS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COURS actions', async () => {
      const expectedActions = [
        {
