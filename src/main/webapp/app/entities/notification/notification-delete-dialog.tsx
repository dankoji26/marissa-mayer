...
export const NotificationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="marissamayerApp.notification.delete.question">
        <Translate contentKey="marissamayerApp.notification.delete.question" interpolate={{ id: notificationEntity.id }}>
