...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './creneau.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CRENEAU_LIST actions', async () => {
    ...
    it('dispatches FETCH_CRENEAU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CRENEAU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CRENEAU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CRENEAU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CRENEAU actions', async () => {
      const expectedActions = [
        {
