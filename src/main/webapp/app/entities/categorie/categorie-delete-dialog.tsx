...
export const CategorieDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="marissamayerApp.categorie.delete.question">
        <Translate contentKey="marissamayerApp.categorie.delete.question" interpolate={{ id: categorieEntity.id }}>
