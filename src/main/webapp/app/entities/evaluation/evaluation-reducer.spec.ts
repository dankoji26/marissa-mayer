...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EVALUATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_EVALUATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EVALUATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EVALUATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EVALUATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EVALUATION actions', async () => {
      const expectedActions = [
        {
