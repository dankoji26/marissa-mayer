...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './catalogue.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CATALOGUE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CATALOGUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CATALOGUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CATALOGUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CATALOGUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CATALOGUE actions', async () => {
      const expectedActions = [
        {
