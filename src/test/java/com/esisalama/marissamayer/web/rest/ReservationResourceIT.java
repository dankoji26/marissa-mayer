...
class ReservationResourceIT {
    ...
    private static final ReservationStatuts DEFAULT_STATUTS = ReservationStatuts.REJETEE;
    private static final ReservationStatuts UPDATED_STATUTS = ReservationStatuts.EN_ATTENTE;
